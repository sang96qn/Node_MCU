...
#define ssid "CoE-C1"
#define password "publicwifi"
const char *mqtt_user = "rpbrszen";
const char *mqtt_pass = "TRTYgaKpLV_I";
#define mqtt_server "m11.cloudmqtt.com" // cloud mqtt
#define mqtt_topic_pub "Light"
#define mqtt_topic_sub "Light"
const uint16_t mqtt_port = 10366;// default
